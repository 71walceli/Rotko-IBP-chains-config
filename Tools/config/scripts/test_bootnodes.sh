...
readonly POLKADOT_BINARY="/App/polkadot"
readonly POLKADOT_PARACHAIN_BINARY="/App/polkadot-parachain"
readonly JQ_BINARY="/usr/bin/jq"
readonly OUTPUT_DIR="/Data/bootnode_tests"
readonly DATA_DIR="/Data/bootnode_data"
readonly OUTPUT_FILE="$OUTPUT_DIR/results.json"
readonly BOOTNODES_JSON="/Config/bootnodes.json"
